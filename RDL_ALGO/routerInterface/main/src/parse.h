...
public:
    ...
    string name;
    vector<Coord *> unplaced_pinLocs; //chiplet作为单个instance的相对坐标
    vector<Coord *> placed_pinLocs; //exclude used pinLocs 在top design放置后的坐标(x,y) 
    ...
    vector<string> signals; // 所有signal
