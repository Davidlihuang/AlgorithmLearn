...
void readNodeTable(int nodeID[100], long nodeSD[100])
{
    ...
    nodeColumn1.open("Demo_Data/nodeID.csv", ios::in);
    nodeColumn2.open("Demo_Data/nodeSD.csv", ios::in);
...
void readArcTable(int arcFrom[158], int arcTo[158], int arcMin[158], long arcMax[158], long arcWeight[158])
{
    ...
    arcColumn1.open("Demo_Data/arcFrom.csv", ios::in);
    arcColumn2.open("Demo_Data/arcTo.csv", ios::in);
    arcColumn3.open("Demo_Data/arcMin.csv", ios::in);
    arcColumn4.open("Demo_Data/arcMax.csv", ios::in);
    arcColumn5.open("Demo_Data/arcWeight.csv", ios::in);
...
int main(int argc, char *argv[])
{
    ...
    ifstream node_arc_Num("Demo_Data/nodeNum_arcNum.csv");
