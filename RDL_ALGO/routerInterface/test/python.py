...
def fp_plot_3pin(arrange, FL, filename_pin, filename_bp_route, filename_2pin_nets_route, filename_3pin_net_res):
    ...
    plt.xticks(np.arange(0, arrange+100, 20))
    plt.grid()
    plt.savefig('./output/layout_3_pin_nets.png')
    plt.show()


if __name__ == '__main__':
    #filename_fig = sys.argv[1]
    filename_pinLocs = './output/outpin.txt'
    ...
    fp_plot(arrange=1100, FL=[1100, 1100],
            filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_compact.txt',
            filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_compact.png')
    fp_plot_by_RDL(arrange=1100, FL=[1100, 1100],
                   filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_compact.txt',
                   filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_compact_RDL1.png', RDLnum=1)
    fp_plot_by_RDL(arrange=1100, FL=[1100, 1100],
                   filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_compact.txt',
                   filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_compact_RDL2.png', RDLnum=2)
    fp_plot_by_RDL(arrange=1100, FL=[1100, 1100],
                   filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_compact.txt',
                   filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_compact_RDL3.png',  RDLnum=3)

    fp_plot(arrange=1100, FL=[1100, 1100],
            filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_uncompact.txt',
            filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_uncompact.png')
    fp_plot_by_RDL(arrange=1100, FL=[1100, 1100],
                   filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_uncompact.txt',
                   filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_uncompact_RDL1.png', RDLnum=1)
    fp_plot_by_RDL(arrange=1100, FL=[1100, 1100],
                   filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_uncompact.txt',
                   filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_uncompact_RDL2.png', RDLnum=2)
    fp_plot_by_RDL(arrange=1100, FL=[1100, 1100],
                   filename_pin=filename_pinLocs, filename_bp_route='./output/bp_routing.txt', filename_2pin_nets_route='./output/routing_path_2pin_nets_uncompact.txt',
                   filename_3pin_net_res='./output/maze_route_multipin.txt', fig_filename='./output/layout_uncompact_RDL3.png',  RDLnum=3)
