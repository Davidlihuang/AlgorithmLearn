...
void DbWrapper::initIoPins(int nMinSpace, int nPadWidth, int nPadHeight, int nPinWidth, int nPinHeight, const std::vector<std::string> &vecPinNames, const std::vector<std::string> &vecNetNames, const std::vector<StruPinLocation> &vecIoPinLocations)
{
