...
public:
    ...
    void search_feasible_bp(IO_parse *IOs_parse, vector<Track_IO *> &vec_track,
                     int x_OB, int y_OB, int W_FP, int H_FP, vector<BP *> &vec_BP);
    bool is_track_avaible_and_mark_as_used(Coord *src_coord_track, 
                    Coord *dest_coord_track, Coord *bp_coord, vector<Track_IO *> &vec_track, IO_parse *IOs_parse);
